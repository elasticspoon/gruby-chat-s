{
  ...
  gruf = {
    dependencies = ["activesupport" "concurrent-ruby" "e2mmap" "grpc" "grpc-tools" "json" "slop" "thwait" "zeitwerk"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0qnsk0b8ni305llmqf94hnng460dblfnx8jw554ihr05kdhkylcf";
      type = "gem";
    };
    version = "2.18.0";
  };
